...
//   return (
//     <section id="about" ref={sectionRef} className="py-20 lg:py-32 bg-[#f7f7eb] relative overflow-hidden">
//       {/* Decorative */}
...
//             <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold mt-4 mb-6 leading-tight text-[#588157]">
...
const AboutSection = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-20 lg:py-28 bg-[#F5F5F5] relative overflow-hidden">

      {/* LIGHT RED GLOW */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#E63946]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#E63946]/5 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="about-image relative">
            ...
            {/* FLOAT CARD */}
            <div className="absolute -bottom-5 -right-5 bg-white rounded-2xl shadow-lg p-5 max-w-[200px] border border-gray-200">
              <div className="text-3xl font-bold text-[#E63946]">15+</div>
              <div className="text-xs text-gray-500 mt-1">
                Years of Excellence in Tinting
              </div>
            </div>

            {/* ACCENT BORDER */}
            <div className="absolute -top-4 -left-4 w-20 h-20 border-2 border-[#E63946]/20 rounded-2xl" />
          </div>
          ...
          <div className="about-text">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4 mb-6 leading-tight text-[#111111]">
              Professional Tinting for{' '}
              <span className="text-[#E63946]">Homes & Offices</span>
            </h2>

            <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-8">
              At DSP-TINTS, we provide premium window tinting solutions for residential and
              commercial properties. Our expert team ensures high-quality installation with
              films that reduce heat, block UV rays, enhance privacy, and improve energy efficiency.
            </p>
            ...
            <div className="space-y-3 mb-8">
              {features.map((f, i) => (
                <div key={i} className="flex items-center gap-3">
                  <FaCheckCircle className="text-[#E63946] text-sm" />
            ...
            <a
              href="#contact"
              className="inline-block px-7 py-3 rounded-full font-semibold text-white bg-[#E63946] hover:bg-[#C92F3A] transition-all shadow-md hover:shadow-lg hover:scale-105"
            >
              Book Consultation →
            </a>
          </div>
        ...
        {/* STATS */}
        <div className="about-stats grid grid-cols-2 md:grid-cols-4 gap-5 sm:gap-6 mt-16">

          {stats.map((stat, i) => (
            <div
              key={i}
              className="about-stat bg-white rounded-2xl p-5 text-center border border-gray-200 shadow-sm hover:shadow-md transition-all hover:-translate-y-1"
            >
              <div className="text-[#E63946] text-2xl mb-2 flex justify-center">
                {stat.icon}
              </div>
